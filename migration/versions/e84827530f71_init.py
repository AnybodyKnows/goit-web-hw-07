...
Revision ID: e84827530f71
Revises: 
Create Date: 2024-05-06 16:45:05.708446
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('SubjectName', sa.String(length=255), nullable=False),
    sa.Column('TeacherID', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['TeacherID'], ['teachers.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('DateReceived', sa.Date(), nullable=False),
